...
public class JackTokenizer {
	...
	public JackTokenizer(String program){
		...
		this.keywordPattern = Pattern.compile("^(?:class|constructor|function|method|field|static|var|int|char|boolean|void|true|false|null|this|let|do|if|else|while|return)\\b");
